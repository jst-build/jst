...
Arguments with default values are optional and may be omitted.
...
> integer and negative numbers count from the end of the list.
...
Compute the conjunction of given arguments' *truth value*.  
...
Compute the disjunction of given arguments' *truth value*.
