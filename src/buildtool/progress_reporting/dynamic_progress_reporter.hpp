...
#ifndef INCLUDED_SRC_BUILDTOOL_PROGRESS_REPORTING_DYNAMIC_PROGRESS_REPORTER_HPP
#define INCLUDED_SRC_BUILDTOOL_PROGRESS_REPORTING_DYNAMIC_PROGRESS_REPORTER_HPP
